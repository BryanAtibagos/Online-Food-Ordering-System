            ...
            <div class="col-md-12 mb-2">
                <div class="card mt-3">
                    <div class="card-header">
                        <h3 class="text-center">My Cancellations</h3>
                    </div>
                </div>
                <br>
            </div>
...
<div class=""><a href="confirm_order.php" class="btn btn-info">My Orders</a></div>
        <?php 

           
$cart_query = mysqli_query($conn, "SELECT * FROM ordered_product WHERE customer_id = $customer_id AND order_status = '3' ORDER BY ordered_product_id DESC") or die ('query failed');
